...
namespace DataViewer
{
    public partial class CompareForm : System.Windows.Forms.Form
    {
        ...
        public CompareForm(string location, string filename)
        {
            InitializeComponent();
            Location = location;

            this.Resize += CompareForm_Resize;

            var distancesFile = Path.Combine(Location, filename);
        ...
        private void CompareForm_Resize(object sender, EventArgs e)
        {
